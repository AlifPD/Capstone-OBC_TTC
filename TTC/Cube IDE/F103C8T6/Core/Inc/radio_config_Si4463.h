...
// MOD_type: 3    Rsymb(sps): 4800    Fdev(Hz): 5000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 437    API_TC: 29    fhst: 250000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -468750 Hz
// # WB filter 3 (BW =  30.87 kHz);  NB-filter 3 (BW = 30.87 kHz)
// 
// Modulation index: 2,083
*/
...
*/
#define RF_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x01, 0x04, 0x01, 0xF7, 0x51, 0x00, 0xFC, 0x02, 0xC2
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0x80, 0x0E, 0x0C, 0x7D, 0x80
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x39, 0x39, 0x00, 0x1A, 0x85, 0x55, 0x00, 0x2A
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x39, 0x0A, 0x22, 0x22, 0x44, 0x44, 0x20, 0xFE
